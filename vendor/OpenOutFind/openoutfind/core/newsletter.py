# openoutfind/core/newsletter.py
"""OpenOutFind newsletter subscription — a plain Brevo form POST.

Subscribes the operator's own email (their connected mailbox address) to the
OpenOutFind newsletter. Nothing here touches the retired channel: the subscription
...
def subscribe_to_newsletter(email: str) -> bool:
    """Subscribe *email* to the OpenOutFind newsletter via the Brevo form.
