...
// Soft, low lift — enough depth without a heavy 3D bevel.
const BEVEL_LIGHT =
  "shadow-[0_1px_2px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.55)]";
const PRESSED_LIGHT =
  "active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)]";

const BEVEL_DARK =
  "shadow-[0_1px_2px_rgba(0,0,0,0.16),inset_0_1px_0_rgba(255,255,255,0.12)]";
const PRESSED_DARK =
  "active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.28)]";
...
const VARIANT: Record<ThreeDButtonVariant, string> = {
  ...
  primary: cn(
    "bg-[#4379EE] text-white hover:bg-[#3567D6] active:bg-[#2A55B5]",
    "shadow-[0_1px_2px_rgba(20,50,150,0.18),inset_0_1px_0_rgba(255,255,255,0.22)]",
    "active:shadow-[inset_0_1px_2px_rgba(10,30,100,0.28)]",
  ),
};
