...
export function HeroFeaturesSection() {
  return (
    <section id="hero" className="relative bg-white h-[100svh] min-h-[720px] p-2.5 sm:p-5">
      <div className="relative flex h-full w-full flex-col overflow-hidden rounded-[28px] sm:rounded-[40px] border border-[#C5DBFF] bg-gradient-to-b from-white from-[40%] via-[#A8C8FF] via-[78%] to-[#4379EE]">
        <div
