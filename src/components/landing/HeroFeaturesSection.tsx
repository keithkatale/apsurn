...
const CAPABILITIES = ["ICP blueprint", "Verified emails", "Gmail sequences", "AI Copilot"];
        ...
        <div className="relative z-10 mx-auto flex h-full w-full max-w-[1300px] flex-col px-5 pt-16 pb-8 sm:px-10 sm:pt-20 sm:pb-10 lg:px-20 lg:pb-12">
          <div className="flex flex-1 flex-col items-center justify-center">
            <div className="w-full max-w-[720px] flex flex-col items-center text-center gap-7 sm:gap-8">
              ...
              <p className="max-w-[520px] text-[15px] sm:text-[16px] text-[#605F5F] tracking-[-0.64px] leading-[1.3] font-normal font-sans">
                Turn your website into an ICP blueprint, find verified prospects, and run Gmail sequences —
                an AI SDR loop built for outbound GTM.
              </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            {CAPABILITIES.map((label) => (
              <span
                key={label}
                className="rounded-full border border-white/30 bg-white/15 px-3 py-1.5 text-[12px] font-medium tracking-tight text-white backdrop-blur-sm sm:text-[13px]"
              >
                {label}
              </span>
            ))}
