...
const STROKE = `stroke="#4379EE" stroke-width="1.65" stroke-linecap="round" stroke-linejoin="round" fill="none"`;

function wrap(inner: string): string {
  return `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="24" height="24" rx="6" fill="#E8F1FC"/>${inner}</svg>`;
}
...
const MOTIFS = {
  ...
  target: wrap(`<circle cx="12" cy="12" r="6.2" ${STROKE}/><circle cx="12" cy="12" r="3.1" ${STROKE}/><circle cx="12" cy="12" r="1.05" fill="#4379EE" stroke="none"/>`),
  follow: wrap(`<path d="M6.5 8.5h7.2v7.2H6.5z" ${STROKE}/><path d="M10.8 8.5V6.8h6.7v6.7H16" ${STROKE}/>`),
  rocket: wrap(`<path d="M14.8 6.6c2.4 2.4 2.6 5.3 1.1 6.8L12 17.3 6.7 12l3.9-3.9c1.5-1.5 4.4-1.3 6.8 1.1Z" ${STROKE}/><path d="M9.4 14.6 7 17.2M11.2 16.2 9.4 18" ${STROKE}/><circle cx="13.35" cy="10.65" r="1.05" fill="#4379EE" stroke="none"/>`),
  ...
  spark: wrap(`<path d="M12 6.2 13.1 10 17 11.2 13.1 12.4 12 16.2 10.9 12.4 7 11.2 10.9 10Z" ${STROKE}/><path d="M17.4 15.2 18 16.8 19.6 17.4 18 18 17.4 19.6 16.8 18 15.2 17.4 16.8 16.8Z" fill="#4379EE" stroke="none"/>`),
